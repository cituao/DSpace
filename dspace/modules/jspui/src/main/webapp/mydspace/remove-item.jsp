...
<br/>
    ...
    <form action="<%= request.getContextPath() %>/mydspace" method="post">
		...
		<div class="full-width-container">
			<input class="btn btn-primary col-md-2" type="submit" name="submit_delete" value="<fmt:message key="jsp.mydspace.remove-item.remove.button"/>" />
			<input class="btn btn-primary col-md-2" type="submit" name="submit_cancel" value="<fmt:message key="jsp.mydspace.remove-item.cancel.button"/>" />
		</div>
    </form>
</dspace:layout>
