        ...
        <div class="panel-heading" style="padding-left: 0">
            ...
            <form style="margin-top:5px;" class="pull-right" action="<%= request.getContextPath() %>/mydspace" method="post">
               ...
               <input  class="btn btn-primary"  type="submit" name="submit_new" value="<fmt:message key="jsp.mydspace.main.start.button"/>" />
                <input class="btn btn-primary" type="submit" name="submit_own" value="<fmt:message key="jsp.mydspace.main.view.button"/>" />
		    </form>
                </h1>
...
%>
    ...
    <table class="table  no-first-cell" align="center" summary="Table listing the tasks in the pool">
        <tr>
...
%>
        <tr>
            ...
            <td headers="t13" class="<%= row %>RowOddCol">
                <form class="pull-right" action="<%= request.getContextPath() %>/mydspace" method="post">
                    <input type="hidden" name="step" value="<%= MyDSpaceServlet.MAIN_PAGE %>"/>
                    <input type="hidden" name="workspace_id" value="<%= workspaceItems[i].getID() %>"/>
                    <input class="btn btn-primary" type="submit" name="submit_open" value="<fmt:message key="jsp.mydspace.general.open" />"/>
                    <input class="btn btn-primary" type="submit" name="submit_delete" value="<fmt:message key="jsp.mydspace.general.remove" />"/>
                </form> 
            </td>
        </tr>
<%
