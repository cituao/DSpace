...
<%
	...
	else 
	{
        ...
        Metadatum[] authorsValue = item.getDC("contributor", "author",  Item.ANY);
        Metadatum[] dateValue = item.getDC("date", "issued",  Item.ANY);
		...
		else
		{
			...
			author = authorsValue[0].value;
            }else{
            author = " ";
            }
   
         if(dateValue.length != 0){
			date = dateValue[0].value;
            }else{
            date = " ";
            }
...
<div class="sideContainer">
                <div class="well" id="item">
                    <h5><%= date %></h5>
                    
                    <h2><%= title %></h2>
                    <h4 class="cabin"><%= author %></h4>
                ...
                <h6><fmt:message key="jsp.display-item.identifier"/></h5>
