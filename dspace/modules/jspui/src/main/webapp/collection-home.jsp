    ...
    <div class="well">
        <div class="row">
            <div id="collectionImgContainer">
                    ...
                    <% 	}else { %>
                         <img class="img-responsive" alt="Logo" src="<%= request.getContextPath() %>/image/noCollectionImg.jpg" />
                    <%    } %>
                        </div>
            <div class="collectionMainTitle">
                    ...
                    <a class="statisticsLink btn" 
                    href="<%= request.getContextPath() %>/handle/<%= collection.getHandle() %>/statistics">
                        <fmt:message key="jsp.collection-home.display-statistics"/>
                    </a>
                    <p class="copyrightText"><%= copyright %></p>
                    <h4 class="lightRed"><fmt:message key="jsp.collection-home.heading1"/></h4>
            </div><!--itemMainTitle-->
        </div><!--row-->
...
%>
    ...
    <div class="browse_rang listContainer">
        <h1>
