...
%></div>
	<br/>
        ...
        %>
            <br/>
            <br/>
        <!--<div class="full-width-container col-md-<%= (bSherpa?2:1) * col*2 + 4 %>">  BEFORE-->
    	<div class="full-width-container">
				...
				<%  } %>
                    ...
                    <%
                        ...
                        {
                    %>
                                <input class="btn btn-warning col-md-2" type="submit" name="<%=UploadStep.SUBMIT_SKIP_BUTTON%>" value="<fmt:message key="jsp.submit.choose-file.skip"/>" />
                           <!--<input class="btn btn-warning col-md-<%= 12 / (col + 2) %>" type="submit" name="<%=UploadStep.SUBMIT_SKIP_BUTTON%>" value="<fmt:message key="jsp.submit.choose-file.skip"/>" /> BEFORE -->
                    <%
                        }
                    %>   
                        <input class="btn btn-primary col-md-2" type="submit" name="<%=UploadStep.SUBMIT_UPLOAD_BUTTON%>" value="<fmt:message key="jsp.submit.general.next"/>" />
        </div>                
    </form>
<%
  if (bSherpa)
