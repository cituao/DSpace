...
%>
		...
		<td headers="t1" class="<%= row %>RowEvenCol" align="center">
		    <input class="form-control" type="radio" style="width:18px;"name="primary_bitstream_id" value="<%= bitstreams[i].getID() %>"
			   <% if (bundles[0] != null) {
            ...
            <%      // Don't display "remove" button in workflow mode
			        ...
			        {
			%>
	                    <button class="btn btn-primary pull-right" type="submit" name="submit_remove_<%= bitstreams[i].getID() %>" value="<fmt:message key="jsp.submit.upload-file-list.button2"/>">
			...
			<%
                ...
                <td headers="t4" class="<%= row %>RowOddCol">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit_describe_<%= bitstreams[i].getID() %>" value="<fmt:message key="jsp.submit.upload-file-list.button1"/>">
                ...
                <td headers="t5" class="<%= row %>RowEvenCol">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit_format_<%= bitstreams[i].getID() %>" value="<fmt:message key="jsp.submit.upload-file-list.button1"/>">
...
<%
    ...
    {
%>
            <div class="row"><input class="btn btn-primary col-md-2 col-md-offset-5" type="submit" name="submit_more" value="<fmt:message key="jsp.submit.upload-file-list.button4"/>" /></div>
<%
    }
%>
<br/>
...
%>
            ...
            <input class="" type="submit" name="submit_show_checksums" value="<fmt:message key="jsp.submit.upload-file-list.button3"/>" /></li>
<%
        }
%>
        </ul>
...
<br/>
		...
		{ %>
			<div class="full-width-container">
				<input class="btn btn-primary col-md-2" type="submit" name="<%=AbstractProcessingStep.PREVIOUS_BUTTON%>" value="<fmt:message key="jsp.submit.general.previous"/>" />
				<input class="btn btn-primary col-md-2" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.general.cancel-or-save.button"/>" />
				<input class="btn btn-primary col-md-2" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.general.next"/>" />
